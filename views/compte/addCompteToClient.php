            ...
            <div class="card-body">
                <form action="/bank_giage/controllers/compteCtrl.php" method="post">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="cni" value="<?= $client['cni'] ?>" readonly >
                        </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="nom" value="<?= $client['nom'] ?>" readonly>
                        </div>
                        <div class="col-md-2 text-left">
                            <label for="prenom" class="h5">PRENOM</label>
                        </div>
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="prenom" value="<?= $client['prenom'] ?>" readonly>
                        </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="tel" value="<?= $client['tel'] ?>" readonly>
                        </div>
                        <div class="col-md-2 text-left">
                            <label for="adresse" class="h5">ADRESSE</label>
                        </div>
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="adresse" value="<?= $client['adresse'] ?>" readonly>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 offset-5 mt-4">
                            <input type="submit" name="btnAddCompteToClient" class="btn btn-md btn-info">
                        </div>
                    </div>
                </form>
            </div>
